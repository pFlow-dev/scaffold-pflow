...
export default function Arc(props: ArcProps) {
  ...
  const { x1, y1, x2, y2, midX, midY, offsetX, offsetY } = positions();
  ...
  return (
    <g onContextMenu={onContextMenu}>
      <line stroke={stroke()} strokeWidth={1} markerEnd={getMarker()} id={props.id} x1={x1} y1={y1} x2={x2} y2={y2} />
